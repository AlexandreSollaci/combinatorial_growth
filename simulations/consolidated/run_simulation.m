...
figure(6)
plot(periods, growth, ':k', periods, growth_subs(:,3), '-k', periods, growth_subs(:,8), '--k')
xlim([beg_year, beg_year+Tmax])
legend('No subsidy', '10% NT', '10% NC')
title('Rate of Growth')
...
figure(7)
subplot(2,2,1)
plot(periods(substime), log(consumption(substime)), ':k', periods(substime), log(consumption_subs(substime,3)), '-k', periods(substime), log(consumption_subs(substime,8)), '--k')
xlim([min(periods(substime)), max(periods(substime))])
legend('No subsidy', '10% NT', '10% NC', 'location','Northwest')
title('Consumption (logs)')
subplot(2,2,2)
plot(periods(substime), log(firm_cost(substime)), ':k', periods(substime), log(firm_cost_subs(substime,3)), '-k', periods(substime), log(firm_cost_subs(substime,8)), '--k')
xlim([min(periods(substime)), max(periods(substime))])
legend('No subsidy', '10% NT', '10% NC','location','Northwest')
title('Firms` Costs (logs)')
subplot(2,2,3)
plot(periods(substime), log(inventor_cost(substime)), ':k', periods(substime), log(inventor_cost_subs(substime,3)), '-k', periods(substime), log(inventor_cost_subs(substime,8)), '--k')
xlim([min(periods(substime)), max(periods(substime))])
legend('No subsidy', '10% NT', '10% NC','location','Northwest')
title('Inventors` Costs (logs)')
subplot(2,2,4)
plot(periods(substime), log(policy_cost(substime)), ':k', periods(substime), log(policy_cost_subs(substime,3)), '-k', periods(substime), log(policy_cost_subs(substime,8)), '--k')
xlim([min(periods(substime)), max(periods(substime))])
legend('No subsidy', '10% NT', '10% NC','location','Northwest')
...
figure(8)
subplot(2,2,1)
plot(periods(substime), consumption_subs(substime,3) - consumption(substime), '-k', periods(substime), consumption_subs(substime,8) - consumption(substime), '--k')
xlim([min(periods(substime)), max(periods(substime))])
legend('10% NT', '10% NC', 'location','Northwest')
title('Change in Consumption')
subplot(2,2,2)
plot(periods(substime), firm_cost_subs(substime,3) - firm_cost(substime), '-k', periods(substime), firm_cost_subs(substime,8) - firm_cost(substime), '--k')
xlim([min(periods(substime)), max(periods(substime))])
legend('10% NT', '10% NC','location','Northwest')
title('Change in Firms` Costs')
subplot(2,2,3)
plot(periods(substime), inventor_cost_subs(substime,3) - inventor_cost(substime), '-k', periods(substime), inventor_cost_subs(substime,8) - inventor_cost(substime), '--k')
xlim([min(periods(substime)), max(periods(substime))])
legend('10% NT', '10% NC','location','Northeast')
title('Change in Inventors` Costs')
subplot(2,2,4)
plot(periods(substime), policy_cost_subs(substime,3) - policy_cost(substime), '-k', periods(substime), policy_cost_subs(substime,8) - policy_cost(substime), '--k')
xlim([min(periods(substime)), max(periods(substime))])
legend('10% NT', '10% NC','location','Northwest')
...
figure(9)
plot(periods(substime), log(GDP(substime)), ':k', periods(substime), log(GDP_subs(substime,3)), '-k', periods(substime), log(GDP_subs(substime,8)), '--k')
legend('No subsidy', '10% NT', '10% NC','location','Northwest')
title('GDP (logs)')
xlabel('Year')
xlim([min(periods(substime)), max(periods(substime))])
...
figure(10)
subplot(2,2,1)
plot(patent_shares(substime,1),patent_shares(substime,2), ':k', patent_shares(substime,1),patent_shares_subs(substime,2,3), '-k',...
    patent_shares(substime,1),patent_shares_subs(substime,2,8), '--k')
legend('No subsidy', '10% NT', '10% NC','location','Northeast')
title('Share of NT Patents')
xlabel('Year')
xlim([min(periods(substime)), max(periods(substime))])
subplot(2,2,2)
plot(patent_shares(substime,1),patent_shares(substime,3), ':k', patent_shares(substime,1),patent_shares_subs(substime,3,3), '-k',...
    patent_shares(substime,1),patent_shares_subs(substime,3,8), '--k')
legend('No subsidy', '10% NT', '10% NC','location','Northwest')
title('Share of NC Patents')
xlabel('Year')
xlim([min(periods(substime)), max(periods(substime))])
subplot(2,2,3)
plot(patent_shares(substime,1),patent_shares(substime,4), ':k', patent_shares(substime,1),patent_shares_subs(substime,4,3), '-k',...
    patent_shares(substime,1),patent_shares_subs(substime,4,8), '--k')
legend('No subsidy', '10% NT', '10% NC','location','Southwest')
