function  return_vars = simulate_path_zeta(Tmax, params, nrofinv, period, subsidy, quality, Mmat, summat_input, state, seed)


    % return_vars = simulate_path_zeta(Tmax, params, nrofinv, period, use_seed, seed, subsidy, quality, Mmat, summat_input, state)
	...
	for t = 1:Tmax  % number of years of iteration.
	    ...
	    for j=1:Mt
	        ...
	        [mstar,aalpha] = modeldraws(j, ttau, llambda, kkappa);
